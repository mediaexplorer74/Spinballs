...
// Type: Spinballs.Core.Controls.TutorialPanel1
...
{
  public class TutorialPanel1 : ImageControl
  {
    public TutorialPanel1(ActionManager actionManager) => this.ActionManager = actionManager;
    ...
    public override void Create()
    {
      ...
      ImageControl imageControl = new ImageControl(Res.StartScreen.Tutorial1);
      ...
      labelControl.Text = Strings.Tutorial1;
