...
// Type: Spinballs.Core.Controls.TutorialPanel2
...
{
  public class TutorialPanel2 : ImageControl
  {
    public TutorialPanel2(ActionManager actionManager) => this.ActionManager = actionManager;
    ...
    public override void Create()
    {
      ...
      ImageControl imageControl = new ImageControl(Res.StartScreen.Tutorial2);
      ...
      labelControl.Text = Strings.Tutorial2;
